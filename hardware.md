...
* ENA  Arduino Pin 3 (PWM Speed Left)
* IN1  Arduino Pin 8
* IN2  Arduino Pin 9
* IN3  Arduino Pin 12
* IN4  Arduino Pin 13
* ENB  Arduino Pin 11 (PWM Speed Right)

### Ultrasonic Sensors:
* Left Sensor: Trig  Pin A0, Echo  Pin A1
* Center Sensor: Trig  Pin A2, Echo  Pin A3
* Right Sensor: Trig  Pin A4, Echo  Pin A5
* Power: Connect all Sensor VCC pins to Arduino 5V and GND to GND.

### Line Sensors (Digital):
* Left Line Sensor OUT  Pin 2
* Right Line Sensor OUT  Pin 10
* Power: Sensor VCC to Arduino 5V, GND to Arduino GND.

### Servo Connections:
* Right Shoulder Servo Signal  Pin 4
* Left Elbow Servo Signal  Pin 5
* Right Elbow Servo Signal  Pin 6
* Wrist/Gate Servo Signal  Pin 7
* Servo power should come from a stable external 5V source with common GND to Arduino.
